...
## Configurable clinical data harmonization with help from LLMs {.title-hero background-gradient="linear-gradient(135deg, #BE2BBB 0%, #8f1f8d 100%)"}

::: {.title-byline}
Leslie Emery\
Informatics & Predictive Sciences | Bristol Myers Squibb
:::

<!-- Change background to image of BMS Seattle office -->

::: {.notes}
- I'm a data scientist at BMS in Seattle
:::
...
<!-- https://contentcentral.bms.com/content/bms/en-us/search/asset-details-page.html/content/dam/bms/ca/bms-stock-image-library/adobe-stock/life/AdobeStock_158958915.jpeg -->
...
- Many files from many studies, custom code for each input file to output transformation, lots of variation in the code, lots of repeating the same kinds of things over an over again
:::
